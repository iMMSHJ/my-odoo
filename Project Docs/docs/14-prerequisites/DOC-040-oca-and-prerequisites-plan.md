...
> **🔴 به‌روزرسانی — تأیید واقعی این تصمیم (۲۵ تیر ۱۴۰۵):** در جریان فاز ۰، یک ماژول third-party جایگزین (`persian_calendar`) که از قبل روی محیط نصب بود، دقیقاً همین ریسک را عملی نشان داد — با خطای `picker.disable is not a function` روی Odoo 19 کرش کرد و Uninstall شد. جزئیات کامل رویداد و برنامه نهایی بومی‌سازی فارسی در **DOC-049**.
