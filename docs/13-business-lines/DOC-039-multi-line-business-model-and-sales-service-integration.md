...
فرم تیکت اختصاصی (`pps_ticket_wizard`) باید در **Step 1 (شناسایی نوع درخواست)** یک انتخاب «نوع خدمت» اضافه کند: {سرویس دستگاه، IT، آموزش} — که Team مقصد Ticket را تعیین می‌کند. جزئیات فیلدهای اختصاصی هر نوع (مثلاً آموزش: تاریخ پیشنهادی کلاس) باید در تکرار بعدی DOC-038 اضافه شود.

> **یادداشت برای DOC-038:** این تصمیم نیاز به یک Step اضافه (انتخاب نوع درخواست) قبل از Page 1 دارد — در بازبینی بعدی DOC-038 اعمال می‌شود.
