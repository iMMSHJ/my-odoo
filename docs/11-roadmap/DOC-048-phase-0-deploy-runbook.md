...
| **یافته اضافه (خارج از چک‌لیست اصلی):** `persian_calendar` (third-party، از قبل نصب بود) با Odoo 19 ناسازگار بود و Uninstall شد — جزئیات در DOC-049 | ✅ حل شد | ۲۵ تیر ۱۴۰۵ |
